...
cnn_model.load_state_dict(torch.load("essemble model experiment #1\optimized essemble model experiment\epoch CNN BERT model\epoch_10\cnn_bert10.pt"))
cnn_model.eval()
...
# ----- Write to Excel -----
OUTPUT_FILE = "essemble model experiment #1\optimized essemble model experiment\epoch experiment\CNN+BERT\epoch 10\DRSE_Calibrated_Results_epoch10.xlsx"
