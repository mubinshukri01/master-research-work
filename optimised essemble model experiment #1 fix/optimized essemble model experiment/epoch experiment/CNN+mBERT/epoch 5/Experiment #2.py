...
# Experiment #2: Calibrated Ensemble on Epoch 5 Models
# ===============================================================
...
cnn_model.load_state_dict(torch.load("essemble model experiment #1\optimized essemble model experiment\epoch CNN BERT model (mBERT)\epoch_5\cnn_bert5.pt"))
cnn_model.eval()
...
# ----- Write to Excel -----
OUTPUT_FILE = "essemble model experiment #1\optimized essemble model experiment\epoch experiment\epoch 5\DRSE_Calibrated_Results_epoch5.xlsx"
