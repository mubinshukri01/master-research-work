...
# Experiment #2: Calibrated Ensemble on Epoch 6 Models
# ===============================================================
...
gru_model.load_state_dict(torch.load("essemble model experiment #1\optimized essemble model experiment\epoch GRU keras model\epoch_6\gru_keras6.pt"))
gru_model.eval()

cnn_model = CNN_BERT().to(device)
cnn_model.load_state_dict(torch.load("essemble model experiment #1\optimized essemble model experiment\epoch CNN BERT model (mBERT)\epoch_6\cnn_bert_model6.pt"))
cnn_model.eval()
...
# ----- Write to Excel -----
OUTPUT_FILE = "essemble model experiment #1\optimized essemble model experiment\epoch experiment\epoch 6\DRSE_Calibrated_Results_epoch6.xlsx"
