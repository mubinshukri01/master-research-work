...
metrics_df = pd.DataFrame({
    "Model": ["Keras Word Tokenizer + LSTM"],
    "Accuracy": [accuracy],
...
with pd.ExcelWriter("Phase 3/Sentiment distribution/Keras Word Token/keras_word_lstm.xlsx", engine="xlsxwriter") as writer:
