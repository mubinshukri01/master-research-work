...
metrics_df = pd.DataFrame({
    "Model": ["Keras Word Tokenizer + CNN"],
    "Accuracy": [accuracy],
...
with pd.ExcelWriter("Phase 3/Sentiment distribution/Keras Word Token/keras_word_cnn.xlsx", engine="xlsxwriter") as writer:
