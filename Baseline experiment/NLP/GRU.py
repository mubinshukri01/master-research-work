...
metrics_df = pd.DataFrame({
    "Model": ["Keras Word Tokenizer + GRU"],
    "Accuracy": [accuracy],
...
with pd.ExcelWriter("Phase 3/Sentiment distribution/Keras Word Token/keras_word_gru.xlsx", engine="xlsxwriter") as writer:
