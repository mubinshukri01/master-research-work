# ===============================================================
# BERT TOKENIZER + LSTM (GPU ENABLED)
# ===============================================================
...
model = TextLSTM(tokenizer.vocab_size, num_classes).to(device)
...
ax.set_xticks(x)
ax.set_xticklabels(["Human Annotation", "LSTM model Prediction"])
ax.set_ylabel("Percentage of Instances (%)")
ax.set_ylim(0, 100)

ax.set_title("Sentiment Distribution: Human vs LSTM Model")
...
# output_file = "Phase 3/Sentiment distribution/BERT/BERT_tokenizer_lstm.xlsx"
