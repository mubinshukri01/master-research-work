...
gru_model.load_state_dict(torch.load("essemble model experiment #1\optimized essemble model experiment\origin\gru_keras_model.pt"))
gru_model.eval()

cnn_model = CNN_BERT().to(device)
cnn_model.load_state_dict(torch.load("essemble model experiment #1\optimized essemble model experiment\origin\cnn_bert_model.pt"))
cnn_model.eval()
...
# ----- Write to Excel -----
OUTPUT_FILE = "essemble model experiment #1/Result/DRSE_Calibrated_Results#2.xlsx"
