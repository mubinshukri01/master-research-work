...
OUTPUT_PATH = "essemble model experiment #1/optimized essemble model experiment/epoch CNN BERT model (mBERT)/epoch_6/CNN_BERT_Training_Losses6.xlsx"
...
torch.save(model.state_dict(), "essemble model experiment #1/optimized essemble model experiment/epoch CNN BERT model (mBERT)/epoch_6/cnn_bert_model6.pt")
print("Model saved as essemble model experiment #1/optimized essemble model experiment/epoch CNN BERT model (mBERT)/epoch_6/cnn_bert_model6.pt")
