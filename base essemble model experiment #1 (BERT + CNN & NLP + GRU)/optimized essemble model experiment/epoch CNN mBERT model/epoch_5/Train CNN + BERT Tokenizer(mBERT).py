...
OUTPUT_PATH = "essemble model experiment #1/optimized essemble model experiment/epoch CNN BERT model (mBERT)/epoch_5/CNN_BERT_Training_Losses5.xlsx"
...
torch.save(model.state_dict(), "essemble model experiment #1/optimized essemble model experiment/epoch CNN BERT model (mBERT)/epoch_5/cnn_bert5.pt")
print("Model saved as essemble model experiment #1/optimized essemble model experiment/epoch CNN BERT model (mBERT)/epoch_5/cnn_bert5.pt")
