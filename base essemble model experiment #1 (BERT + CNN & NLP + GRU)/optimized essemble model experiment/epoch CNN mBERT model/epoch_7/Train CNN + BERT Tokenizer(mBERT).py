...
OUTPUT_PATH = "essemble model experiment #1/optimized essemble model experiment/epoch CNN BERT model (mBERT)/epoch_7/CNN_BERT_Training_Losses7.xlsx"
...
torch.save(model.state_dict(), "essemble model experiment #1/optimized essemble model experiment/epoch CNN BERT model (mBERT)/epoch_7/cnn_bert7.pt")
print("Model saved as essemble model experiment #1/optimized essemble model experiment/epoch CNN BERT model (mBERT)/epoch_7/cnn_bert7.pt")
