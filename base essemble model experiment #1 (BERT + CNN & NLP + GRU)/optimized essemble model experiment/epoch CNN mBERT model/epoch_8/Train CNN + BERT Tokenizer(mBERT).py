...
OUTPUT_PATH = "essemble model experiment #1/optimized essemble model experiment/epoch CNN BERT model (mBERT)/epoch_8/CNN_BERT_Training_Losses8.xlsx"
...
torch.save(model.state_dict(), "essemble model experiment #1/optimized essemble model experiment/epoch CNN BERT model (mBERT)/epoch_8/cnn_bert8.pt")
print("Model saved as essemble model experiment #1/optimized essemble model experiment/epoch CNN BERT model (mBERT)/epoch_8/cnn_bert8.pt")
