...
# Experiment #2: Calibrated Ensemble on Epoch 9 Models
# ===============================================================
...
gru_model.load_state_dict(torch.load("essemble model experiment #1\optimized essemble model experiment\epoch GRU keras model\epoch_9\gru_keras9.pt"))
gru_model.eval()

cnn_model = CNN_BERT().to(device)
cnn_model.load_state_dict(torch.load("essemble model experiment #1\optimized essemble model experiment\epoch CNN BERT model\epoch_9\cnn_bert9.pt"))
cnn_model.eval()
...
# ----- Write to Excel -----
OUTPUT_FILE = "essemble model experiment #1\optimized essemble model experiment\epoch experiment\CNN+BERT\epoch 9\DRSE_Calibrated_Results_epoch9.xlsx"
