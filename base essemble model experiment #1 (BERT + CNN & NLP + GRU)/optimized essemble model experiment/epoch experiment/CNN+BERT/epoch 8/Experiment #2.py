...
# Experiment #2: Calibrated Ensemble on Epoch 8 Models
# ===============================================================
...
gru_model.load_state_dict(torch.load("essemble model experiment #1\optimized essemble model experiment\epoch GRU keras model\epoch_8\gru_keras8.pt"))
gru_model.eval()

cnn_model = CNN_BERT().to(device)
cnn_model.load_state_dict(torch.load("essemble model experiment #1\optimized essemble model experiment\epoch CNN BERT model\epoch_8\cnn_bert8.pt"))
cnn_model.eval()
...
# ----- Write to Excel -----
OUTPUT_FILE = "essemble model experiment #1\optimized essemble model experiment\epoch experiment\CNN+BERT\epoch 8\DRSE_Calibrated_Results_epoch8.xlsx"
