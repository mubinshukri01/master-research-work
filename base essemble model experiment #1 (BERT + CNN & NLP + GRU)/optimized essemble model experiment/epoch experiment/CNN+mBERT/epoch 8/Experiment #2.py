...
cnn_model.load_state_dict(torch.load("essemble model experiment #1\optimized essemble model experiment\epoch CNN BERT model (mBERT)\epoch_8\cnn_bert8.pt"))
cnn_model.eval()
...
# ----- Write to Excel -----
OUTPUT_FILE = "essemble model experiment #1\optimized essemble model experiment\epoch experiment\epoch 8\DRSE_Calibrated_Results_epoch8.xlsx"
