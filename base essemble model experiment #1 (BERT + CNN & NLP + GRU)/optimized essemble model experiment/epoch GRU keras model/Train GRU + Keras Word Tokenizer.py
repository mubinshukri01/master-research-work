...
#     # ---- Save model ----
#     save_dir = f"essemble model experiment #1/optimized essemble model experiment/epoch GRU keras model/epoch_{EPOCHS}"
#     os.makedirs(save_dir, exist_ok=True)

#     torch.save(model.state_dict(), f"{save_dir}/gru_keras{EPOCHS}.pt")
#     print(f"Saved: {save_dir}/gru_keras.pt")
...
# OUTPUT_PATH = "essemble model experiment #1/optimized essemble model experiment/epoch GRU keras model/GRU_Training_Losses2.xlsx"
