...
lstm_model.load_state_dict(
    torch.load("essemble model experiment #2\epoch_LSTM_mBERT_model\epoch_10\lstm_mbert10.pt")
)
lstm_model.eval()
...
# ----- Write to Excel -----
OUTPUT_FILE = "essemble model experiment #2\epoch experiment\LSTM-mBERT\epoch 10\DRSE_Calibrated_Results#2V1epoch10.xlsx"
